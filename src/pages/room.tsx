  ...
  return (
    <div className="mx-auto max-w-[640px] flex flex-col gap-6 py-10 px-4">
      ...
      <ol className="list-decimal list-outside px-3 space-y-8">
        <Message
          text="jdwuahfywauyfhbwa fbawyu bfwya bfwayf bwayf bwayufawb?"
          ammountOfReactions={100}
          answered
        />
        <Message
          text="jdwuahfywauyfhbwa fbawyu fasjifhansfiusahnfusafhw yhwfgwagfb wayfjafnbashjf?"
          ammountOfReactions={54}
        />
        <Message
          text="afijsaufuashfy87wq hraw fnmaui fhanwf rawbnfyuwahbfywafuawf?"
          ammountOfReactions={32}
        />
        <Message
          text="faksifosajf uas fhjsauifhjasi?"
          ammountOfReactions={12}
        />
      </ol>
    </div>
  );
